...
; 0000 0026 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0027 // State: Bit7=0 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0028 PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(127)
	OUT  0x1B,R30
; 0000 0029 
...
_0x4:
; 0000 0086       {
; 0000 0087       variable=PIND&0x0f; //Enmascaramos los 4 bits menos significativos
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0088       //del puerto A ya que los demás no interesan.
; 0000 0089       if (variable<10) PORTB=tabla7segmentos[variable];
	LDI  R30,LOW(10)
	CP   R5,R30
	BRSH _0x7
	MOV  R30,R5
	...
	LD   R30,Z
	OUT  0x18,R30
; 0000 008A       if (variable>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x7:
	LDI  R30,LOW(10)
	CP   R5,R30
	BRLO _0x8
; 0000 008B       PORTB=0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
